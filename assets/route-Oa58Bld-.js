import{r as _,j as h,b as We}from"./jsx-runtime-DexIYAB0.js";import{c as Ce,a as q,b as P,m as U,t as b,I as ke,H as ue,B as ce,T as Ge,n as de}from"./heading-DTM8AKl4.js";import{D as Ye}from"./decoder-text-BkWt9F-I.js";import{D as Qe}from"./divider-R0j5LyzS.js";import{b as Ze,S as et,F as tt}from"./meta-CIzhMdG3.js";import{i as A,w as Y,x as rt,r as nt,y as at,m as ot,z as st,U as K,E as it,B as lt,C as ut,F as ct,s as dt,G as ft}from"./components-D1Eb6D8q.js";import"./visually-hidden-DdtNGLrw.js";import"./use-spring-C38MhOlx.js";import"./index-DJbPTdxb.js";import"./config-buGxs9ze.js";/*!
 * cookie
 ...
 *
 * @license MIT
 */function It(...e){return async t=>{for(let r of e){let n=await r(t);if(typeof n<"u"&&n!==null)return n}}}async function qt(e,t){let r=e.headers.get("Content-Type")||"",[n,a]=r.split(/\s*;\s*boundary=/);if(!e.body||!a||n!=="multipart/form-data")throw new TypeError("Could not parse content as FormData.");let o=new FormData,s=Ut(e.body,a);for await(let i of s){if(i.done)break;typeof i.filename=="string"&&(i.filename=i.filename.split(/[/\\]/).pop());let l=await t(i);typeof l<"u"&&l!==null&&o.append(i.name,l)}return o}/**
 * @remix-run/server-runtime v2.7.1
 *
 * Copyright (c) Remix Software Inc.
 *
 ...
 *
 * @license MIT
 */function Ne(e){let t={};return Object.values(e).forEach(r=>{let n=r.parentId||"";t[n]||(t[n]=[]),t[n].push(r)}),t}function Pe(e,t="",r=Ne(e)){return(r[t]||[]).map(n=>({...n,children:Pe(e,n.id,r)}))}function Ue(e,t,r="",n=Ne(e)){return(n[r]||[]).map(a=>{let o={hasErrorBoundary:a.id==="root"||a.module.ErrorBoundary!=null,id:a.id,path:a.path,loader:a.module.loader?s=>rr({request:s.request,params:s.params,loadContext:s.context,loader:a.module.loader,routeId:a.id}):void 0,action:a.module.action?s=>tr({request:s.request,params:s.params,loadContext:s.context,action:a.module.action,routeId:a.id}):void 0,handle:a.module.handle};return a.index?{index:!0,...o}:{caseSensitive:a.caseSensitive,children:Ue(e,t,a.id,n),...o}})}/**
 * @remix-run/server-runtime v2.7.1
 *
 * Copyright (c) Remix Software Inc.
 *
 ...
 *
 * @license MIT
 */async function ir(e,t){if(t??(t=sr.REMIX_DEV_ORIGIN),!t)throw Error("Dev server origin not set");let r=new URL(t);r.pathname="ping";let n=await fetch(r.href,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({buildHash:e.assets.version})}).catch(a=>{throw console.error(`Could not reach Remix dev server at ${r}`),a});if(!n.ok)throw console.error(`Could not reach Remix dev server at ${r} (${n.status})`),Error(await n.text())}function lr(e){console.log(`[REMIX DEV] ${e.assets.version} ready`)}const Ie="__remix_devServerHooks";function ur(e){globalThis[Ie]=e}function ve(){return globalThis[Ie]}/**
 * @remix-run/server-runtime v2.7.1
 *
 * Copyright (c) Remix Software Inc.
 *
